...
export class SleepService {
	...
	public getAllOvernightDataStorage() {
		SleepService.AllOvernightData.forEach((element) => {
			this.AllSleepinessDataStorage.get(element.id)
		});
	}

	public getAllSleepinesstDataStorage() {
		SleepService.AllSleepinessData.forEach((element) => {
			this.AllOvernightDataStorage.get(element.id)
		});
	}
}
